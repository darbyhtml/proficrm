...
urlpatterns = [
    ...
    path("mail/campaigns/<uuid:campaign_id>/preview/", views.campaign_html_preview, name="campaign_html_preview"),
    ...
    path("mail/campaigns/<uuid:campaign_id>/retry-failed/", views.campaign_retry_failed, name="campaign_retry_failed"),
    path("mail/campaigns/<uuid:campaign_id>/export-failed/", views.campaign_export_failed, name="campaign_export_failed"),
    path("mail/campaigns/<uuid:campaign_id>/save-as-template/", views.campaign_save_as_template, name="campaign_save_as_template"),
    path("mail/templates/", views.campaign_templates, name="campaign_templates"),
    path("mail/templates/<uuid:template_id>/use/", views.campaign_create_from_template, name="campaign_create_from_template"),
    path("mail/templates/<uuid:template_id>/delete/", views.campaign_template_delete, name="campaign_template_delete"),
