...
urlpatterns = [
    ...
    path("contact-phones/<uuid:contact_phone_id>/cold-call/toggle/", views.contact_phone_cold_call_toggle, name="contact_phone_cold_call_toggle"),
    path("contact-phones/<uuid:contact_phone_id>/cold-call/reset/", views.contact_phone_cold_call_reset, name="contact_phone_cold_call_reset"),
