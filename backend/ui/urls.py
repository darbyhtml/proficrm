...
urlpatterns = [
    ...
    path("companies/<uuid:company_id>/docs/upload/", views.company_document_upload, name="company_document_upload"),
    path("companies/<uuid:company_id>/docs/<uuid:doc_id>/open/", views.company_document_open, name="company_document_open"),
    path("companies/<uuid:company_id>/docs/<uuid:doc_id>/download/", views.company_document_download, name="company_document_download"),
    path("companies/<uuid:company_id>/docs/<uuid:doc_id>/delete/", views.company_document_delete, name="company_document_delete"),
