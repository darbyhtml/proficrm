...
def company_list(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "ui/company_list_v2.html",
        {
            "page": page,
            "qs": qs_no_page,
            "q": q,
            "responsible": f["responsible"],
            "selected_responsibles": f.get("selected_responsibles", []),
            "status": f["status"],
            "selected_statuses": f.get("selected_statuses", []),
            "branch": f["branch"],
            "selected_branches": f.get("selected_branches", []),
            "sphere": f["sphere"],
            "selected_spheres": f.get("selected_spheres", []),
