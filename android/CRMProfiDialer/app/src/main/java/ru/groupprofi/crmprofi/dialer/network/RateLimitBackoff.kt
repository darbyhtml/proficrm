...
class RateLimitBackoff {
    ...
    /**
     * Сбросить backoff (вызывается при успешном ответе 200/204).
     * Использует мягкое снижение вместо резкого обнуления для избежания "пилы"
     * при чередовании успешных и неудачных запросов.
     */
    fun resetBackoff() {
        backoffLevel = 0
    }
