...
**Оценка:** 2-3 часа. **Коммит после завершения.**
...
**Оценка:** 1 час. **Коммит после завершения.**
...
**Оценка:** 3-4 часа. **Коммит после завершения.**
...
## Фаза 5 — DevOps и инфраструктура
...
## Фаза 6 — Фронтенд / UI (Notion-стиль)

**Цель:** единообразный Notion-стиль, accessibility, убрать дублирование CSS.
**Оценка:** 4-5 часов. **Коммит после каждой подфазы.**
...
**Оценка:** 5-6 часов. **Коммит после каждого модуля.**
